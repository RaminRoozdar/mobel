                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="form-group row">
                            <label for="login" class="col-sm-4 col-form-label @lang('platform.input-pull')">ایمیل</label>

                            <div class="col-md-7">
                                <input id="text" type="text" dir="ltr" class="form-control{{ $errors->has('login') ? ' is-invalid' : '' }}" name="email" value="{{ old('email') }}" required autofocus>
